...
- **Close-out** (#53). Dependabot configured — weekly, grouped, **opened against `develop`**, nothing
  ...
  **#41's two owner-only steps: see Next.**
...
**#41 — owner-only steps, in progress 2026-09-19:** `neon auth`, and watching a destructive `neon`
command prompt in an ordinary (non-bypass) session. Doc 12 §8.3.
